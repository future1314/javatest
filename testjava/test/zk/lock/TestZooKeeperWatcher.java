        ...
        try {
            ...
            zk = new ZooKeeper(address, sessionTimeout, new Watcher() {
                ...
                public void process(WatchedEvent event) {
                    ...
                    System.out.println("已经触发了 " + event.getType() + " 事件！");//子节点 创建删除 不触发事件吗
                }
            });
            ...
            Stat stat= zk.exists("/tmp_root_path", true);
            if(stat!=null){
...
//                zk.delete("/tmp_root_path", -1);
            ...
            List<String> chi1s= zk.getChildren("/tmp_root_path",true);
            System.out.println(chi1s);
            byte[] chi2s= zk.getData("/tmp_root_path/childPath2",true,null);
            System.out.println(chi2s.toString());
